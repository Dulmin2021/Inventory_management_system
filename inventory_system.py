...
class InventoryManagementSystem:
    ...
    def show_main_frame(self):
        ...
        logout_btn = tk.Button(sidebar_frame, text="📤", font=("Arial", 20), bg="#0047B3", fg="white",
                             relief="flat", command=self.show_login_frame, cursor="hand2")
    ...
    def print_bill(self):
        ...
        Item Code: {item_values[0]}
        Product Code: {item_values[1]}
        Item Name: {item_values[2]}
        Price: ${item_values[3]}
        ...
        messagebox.showinfo("Bill Generated", f"Bill has been saved to {filename}")
